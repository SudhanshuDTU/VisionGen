...
function CreatePost() {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch("http://localhost:4400/api/v1/dalle", {
          method: "POST",
  ...
  return (
    <section className=" max-w-7xl mx-auto">
      <div>
        <h1 className=" font-extrabold text-black text-[32px]">Generate Image using AI</h1>
        <p className="mt-2 text-gray-500 max-w-[500px] text-[14px]">
          Create Imaginating and visually stunning images generated by AI and
