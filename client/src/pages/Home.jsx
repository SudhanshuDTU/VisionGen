...
function Home() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      setloading(true);
      try {
        const response = await fetch("http://localhost:4400/api/v1/post", {
          method: "GET",
  ...
  return (
    <section className=" max-w-7xl mx-auto">
      ...
      <Link to={'https://www.linkedin.com/in/sudhanshu-dtu/'} className=" font-medium">
         Developed By - SUDHANSHU JHA
          </Link>
      </div>
      <div className=" mt-5">
        <FormField labelName={'Search Post'} type={'text'} name={'text'} placeholder={'Search Post'} value={searchText} handleChange={handleSearch} />
      </div>
